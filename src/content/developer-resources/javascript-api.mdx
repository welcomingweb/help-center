...
description: "Use the Welcoming Web JavaScript API to programmatically control widget behavior—no API key needed."
---
...
<Callout type="info">
Once the Welcoming Web widget is embedded on your site, a global JavaScript API becomes available via <code>window.AccessibilityWidgetAPI</code>. No API key or authentication is required.
</Callout>
