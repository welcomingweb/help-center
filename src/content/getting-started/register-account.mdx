...
description: "Learn how to quickly register for a free Welcoming Web account and start managing your sites."
---
...
Welcoming Web makes accessibility management easy, starting with free registration. Follow these simple steps to set up your account and begin improving your site's accessibility right away.
...
- [Understand your Accessibility Scan Results →](../getting-started/understanding-your-accessibility-report)
- [Configure your Accessibility Widget →](../getting-started/explore-dashboard)
