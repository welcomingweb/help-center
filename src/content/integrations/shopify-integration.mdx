...
description: "Effortlessly embed the Welcoming Web widget into your Shopify store."
---
...
<Callout type="info">
Integrate Welcoming Web into Shopify without advanced coding. Enhance your store's accessibility instantly.
</Callout>
...
Scroll down to the bottom of the file and paste your Welcoming Web embed script right before the closing `</body>` tag:
