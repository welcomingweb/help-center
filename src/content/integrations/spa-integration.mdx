...
description: "Guide for integrating and dynamically reinitializing Welcoming Web in Single-Page Applications (React, Angular, Vue)."
---
...
<Callout type="info">
Integrate and dynamically manage the Welcoming Web widget within Single-Page Applications (React, Angular, Vue).
</Callout>

## Why Manual Reinitialization?

Single-Page Applications (SPAs) dynamically load and unload content without full-page reloads. Therefore, the Welcoming Web widget script might require manual reinitialization to reflect configuration changes or after significant route transitions.
